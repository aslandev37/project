...
<main id="js-page-content" role="main" class="page-content mt-3">
    <?php showMessage($_SESSION['status']) ?>
    <div class="subheader">
    ...
    <div class="row">
        <div class="col-xl-12">
            <?php
                if (checkAdmin()) {
                    echo '<a class="btn btn-success" href="CreateUser.php">Добавить</a>';
                }
            ?>
                    ...
                    <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                        <div class="d-flex flex-row align-items-center">
                                <span class="status status-success mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('img/photo/<?php echo $user['photo'];?>'); background-size: cover;"></span>
                                </span>
                            <div class="info-card-text flex-1">
                                <a href="<?php echo 'Edit.php?id='.$user["id"];?>" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <?php if (checkAdmin() || $_SESSION['id'] == $user['id']):?>
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a href="RemoveAction.php?id=<?php echo $user['id'];?>" class="dropdown-item" onclick="return confirm('are you sure?');">
                                        <i class="fa fa-window-close"></i>
                                        Удалить
                                    </a>
                                </div>
                                <span class="text-truncate text-truncate-xl"><?php echo $user['job'].', '.$user['address'];?></span>
                            </div>
